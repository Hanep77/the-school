...
export default async function Siswa({ searchParams, }: PageProps) {
  ...
  const data = await getData(page, length, "wali");
  ...
  return (
    <div className="px-4">
      ...
      <div className="flex items-center justify-between mb-2">
        <h2 className="text-2xl font-semibold text-cyan-800">Wali</h2>
        <Link href="/dashboard/wali/create" className="py-1 px-2 bg-green-500 text-white rounded hover:bg-green-600">+ Add</Link>
      </div>
      {/* end page header */}
      ...
      {/* content */}
      <Table data={data.data} fields={fields} url="wali" />
      {/* end content */}
